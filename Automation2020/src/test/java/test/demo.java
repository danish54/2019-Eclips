...
//Login
		...
		driver.findElement(By.xpath(
				"//body/div[@id='root']/div[1]/div[1]/div[2]/div[1]/div[1]/div[1]/div[1]/div[1]/div[3]/form[1]/div[1]/div[4]/div[1]/div[1]/input[1]"))
				.sendKeys("12345678");
		Thread.sleep(3000);
		// Click on Login
...
//Explicit wait until expected element is found			
		...
		// add-venue,step 1
		// add title
		driver.findElement(By.xpath("//input[@name=\"venueName\" and @placeholder=\"The White House, The MOMA\"]"))
				.sendKeys("Automate");
		...
		driver.findElement(By.xpath("//input[@name='address2' and @placeholder='Address #2']"))
		...
		driver.findElement(
				By.xpath("//input[@id='airport' and @placeholder='Airport closest to venue (including regional)']"))
				.sendKeys("Napa, CA");
		...
		driver.findElement(By.xpath("//input[@name='contactEmail' and @placeholder='email@domain.com']"))
				.sendKeys("garima@yopmail.com");
		driver.findElement(By.xpath("//input[@name='contactPhoneNumber' and @placeholder='(000)-000-0000']"))
				.sendKeys("9998887765");
		driver.findElement(By.xpath("//input[@name='contactJobTitle' and @placeholder='Venue Manager']"))
				.sendKeys("Quality analyst");

		WebElement UploadImage = driver.findElement(By.xpath("//span[contains(text(),'person')]"));
		UploadImage.sendKeys("C:\\Users\\hipster\\Pictures\\Luxe Upload Imag\\16398.jpg");
